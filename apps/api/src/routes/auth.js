...
const JWT_SECRET = process.env.JWT_SECRET; // required; enforced at boot in server.js (no fallback)
const SALT_ROUNDS = 10;

// (Removed in Faz 2a) POST /api/auth/migrate — unauthenticated DDL runner deleted.
